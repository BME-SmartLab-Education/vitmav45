...
# - módosítsd a képek méretét a CIFFAR-10-hez illeszkedve
...
# MEGOLDÁS: CIFAR mérete
input_img = Input(shape=(32, 32, 3))


# MEGOLDÁS: jóval kevesebb réteg
...
# MEGOLDÁS: mnist helyett cifar10
...
# MEGOLDÁS: nem kell az átméretezés
# x_train = np.reshape(x_train, (len(x_train), 28, 28, 1))
# x_test = np.reshape(x_test, (len(x_test), 28, 28, 1))

# MEGOLDÁS: zaj hozzáadása és képek kirajzolása
# 32x32 pixeles
noise_factor = 0.1
...
# MEGOLDÁS: 28x28 helyett 32x32x3 képek
n = 5  # 5 db digit
